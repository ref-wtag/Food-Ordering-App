    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addFoodButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminHomeActivity.this, AdminAddFoodDetailsActivity.class);
        ...
        approveOrderButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminHomeActivity.this, AdminApproveOrderActivity.class);
                startActivity(intent);
            }
        });
    }
